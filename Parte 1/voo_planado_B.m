% ====================================
% Simulação de voo planado - Parte B
% ====================================
clc; clear;
...
x0 = 0;                         % posição horizontal inicial [m]
rho = 1.225 * exp(-H0 / 8000);  % densidade a 10.000m (aproximadamente) [kg/m³] (aproximação da ISA)

%% Condições de voo (CL)
CL_values = linspace(0, 2.5, 10);  % 10 valores igualmente espaçados entre 0 e 2.5
results = [];
